...
const experiences = [
  {
    ...
    company: "Union Systems",
    period: "Jul 2025 — Present (Full Time)",
  ...
  },
  {
    ...
    period: "Sep 2025 — Jun 2026 (Contract)",
    location: "Lagos, Nigeria",
    logoInitials: "PS",
  ...
  },
  {
    ...
    company: "Prizeet",
    period: "Dec 2024 — Jul 2025 (Contract)",
    location: "Lagos, Nigeria",
    logoInitials: "PZ",
  ...
  },
  {
    ...
    company: "Dev HQ",
    period: "Mar 2024 — Feb 2025 (Full Time)",
  ...
  },
  {
    ...
    company: "Barleyfield",
    period: "Oct 2022 — Sep 2023 (Full Time)",
    location: "Lagos, Nigeria",
    logoInitials: "BF",
  ...
  return (
    <section id="experience" className="border-b border-border/50">
      ...
      <div className="pt-9 px-5 sm:px-7">
        ...
        <h2
          ref={headingRef}
          className="font-display text-[28px] sm:text-[32px] md:text-[36px] tracking-[0.04em] leading-none mb-6"
        >
      ...
      <div
        ref={cardsRef}
        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 px-5 sm:px-7 pb-9"
      >
        {experiences.map((exp, idx) => (
          ...
          >
            ...
            <div
              ref={(el) => {
                accentLineRefs.current[idx] = el;
              }}
              className="absolute top-0 left-0 right-0 h-px bg-accent/13"
            />
            ...
            <div className="flex sm:block items-center gap-3 mb-3">
              ...
              <div className="sm:mt-3">
                <p className="font-sans text-[12px] font-medium text-text-role mb-[2px]">
                  {exp.role}
                </p>
                <p className="font-mono text-[12px] tracking-[0.12em] uppercase text-accent mb-[3px]">
                  {exp.company}
                </p>
              </div>
            </div>

            <p className="font-mono text-[11px] tracking-widest uppercase text-text-faint mb-[2px]">
              {exp.period}
            </p>
            <p className="font-mono text-[11px] tracking-widest uppercase text-text-faint mb-3">
              {exp.location}
            </p>
            ...
            <ul className="flex flex-col gap-[6px]">
              {exp.bullets.map((bullet, i) => (
                <li key={i} className="flex gap-2">
                  <span className="text-accent mt-[2px] shrink-0 text-[10px]">
                    ›
                  </span>
                  <span className="font-mono text-[12px] leading-[1.7] text-text-dim">
                    {bullet}
                  </span>
                </li>
              ))}
